...
public class ClassMethodVisitorSeq extends ClassVisitor implements IClassVisitorSeq {

	private IModel model;
	private IClass myClass;
	private ClassVisitor decorated;

	public ClassMethodVisitorSeq(int api) {
		super(api);
	}

	public ClassMethodVisitorSeq(int api, ClassVisitor decorated, IModel model) {
		super(api, decorated);
		this.model = model;
		this.myClass = null;
