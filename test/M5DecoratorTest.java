...
public class M5DecoratorTest {
	...
	public final void testDecoratr() throws IOException {
		...
		String[] classess = { "problem.app.MyMainApp", "problem.asm.ClassDeclarationVisitor",
				"problem.asm.ClassFieldVisitor", "problem.asm.ClassMethodVisitor", "problem.asm.DesignParser",
				"problem.asm.IClassVisitor", "problem.asm.MethodVisitorHelper", "problem.impl.Class",
				"problem.impl.Field", "problem.impl.Method", "problem.impl.Model", "problem.impl.Relation",
				"problem.impl.SDOutputStream", "problem.impl.Sequence", "problem.impl.UMLOutputStream",
				"problem.interfaces.IClass", "problem.interfaces.IField", "problem.interfaces.IMethod",
				"problem.interfaces.IModel", "problem.interfaces.IRelation", "problem.interfaces.ISequence",
				"problem.spotter.AdapterSpotter", "problem.spotter.DecoratorSpotter",
		...
		assertEquals("decorator", adapter.getClassTypes2().get(PatternSpotter.DECORATORSTR));
		assertEquals("decorator", decorator.getClassTypes2().get(PatternSpotter.DECORATORSTR));
		assertEquals("decorator", composite.getClassTypes2().get(PatternSpotter.DECORATORSTR));
	...
	public final void testDecoratr3() throws IOException {
		...
		this.parser = new DesignParser();
		String[] classess = { "problem.z.decorator.Beverage", "problem.z.decorator.CondimentDecorator",
				"problem.z.decorator.DarkRoast", "problem.z.decorator.Decaf", "problem.z.decorator.Espresso",
				"problem.z.decorator.HouseBlend", "problem.z.decorator.Milk", "problem.z.decorator.Mocha",
				"problem.z.decorator.Soy", "problem.z.decorator.StarbuzzCoffee", "problem.z.decorator.Whip" };
		MyMainApp.classes = classess;
		MyMainApp.main(classess);
		...
		assertEquals("component", beverage.getClassTypes2().get(PatternSpotter.DECORATORSTR));
		assertEquals("decorator", condimentDecorator.getClassTypes2().get(PatternSpotter.DECORATORSTR));
		assertEquals("decorator", milk.getClassTypes2().get(PatternSpotter.DECORATORSTR));
		assertEquals("decorator", mocha.getClassTypes2().get(PatternSpotter.DECORATORSTR));
		assertEquals("decorator", soy.getClassTypes2().get(PatternSpotter.DECORATORSTR));
		assertEquals("decorator", whip.getClassTypes2().get(PatternSpotter.DECORATORSTR));
